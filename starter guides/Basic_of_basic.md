...
This manual is created to help players grasp the most important step toward becoming an expert in BAR ( or anything else if reader could understand the underlying concept and apply in other things instead of just in BAR )

## What is Beyond all reason
Beyond all reason or **BAR** is one of the up and coming **RTS** in development. its in **Alpha** state right now and should
be changed sometime in the future. Feedbacks, player's data and bug report will help toward this direction.

The game right now have **PVE**, **PVP** and **campaign** readily avaible for those that are interested in playing

Going more into details **BAR** have multiples concepts and the most basic being **Strategy**, **Real-time** and yes even **game**

Each of those concept comes with a multitude of underlying theory and such will be quite an ammount of information to distill in to one book,
...
preparedness and foward thinking ability

3. management ( The rebelious teen child of control and planning )

resources balancing and efficiency

3. situational awareness

enviroments and opposition awareness

4. situation handling

keeping your head running at the same speed under durress through preparation or mentality
